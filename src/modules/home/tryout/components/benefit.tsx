  ...
  return (
    <div className="py-44 container">
      <div className="flex flex-col items-center mb-28">
        <div className="text-2xl md:text-4xl font-bold mb-5 text-center">
          Pilihan Jitu Hadapi Ujian Masuk Kampus
        </div>
        <div className="text-base md:text-lg max-w-xl text-center">
      ...
      {TryoutLandingPageContent.map((item, idx) => (
        ...
        >
          <div
            ...
            } w-full flex justify-center mt-10 md:mt-0`}
          >
            <div className="w-4/5">
              <div className="text-xl md:text-3xl font-bold pb-3">
                {item.title}
              </div>
